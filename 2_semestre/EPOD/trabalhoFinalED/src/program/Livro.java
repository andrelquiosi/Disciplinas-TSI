...
public class Livro implements Comparable<Livro> {
    ...
    private void lerTXT(String file) throws Exception {
        ...
        atributosLivro(linha);// PEGA OS ATRIBUTOS DO LIVRO QUE ESTï¿½O NA PRIMEIRA LINHA DO TXT
    ...
    //(a) Crie um método toString para Livro que apresente os atributos na tela (exceto conteudo).
    @Override
